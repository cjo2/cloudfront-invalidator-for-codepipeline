...
This Lambda function simply creates a CloudFront Invalidation so that your distibution is updated with the latest objects the next time the edge location's objects are requested again.
